...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recycler_view.adapter = StudentsAdapterAdapter(this.studentList, applicationContext)
        ...
        serv.retriveStudent()
            .enqueue(object : Callback<List<Student>> {
                override fun onResponse(
                    ...
                    recycler_view.adapter = StudentsAdapterAdapter(studentList, applicationContext)
